export class ObjectUtils {
    ...
    public static contains(value: any, list: any) {
    ...
    public static removeAccents(str: any) {
    ...
    public static compare(value1: any, value2:any, locale: any, order = 1) {
        let result = -1;
    ...
    public static sort(value1: any, value2: any, order = 1, locale: any, nullSortOrder = 1) {
