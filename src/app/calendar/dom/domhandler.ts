...
export class DomHandler {
    ...
    public static relativePosition(element: any, target: any): void {
        const getClosestRelativeElement = (el: any): any => {
            if (!el) return;
    ...
    public static getFocusableElements(element: HTMLElement) {
        ...
        for (let focusableElement of focusableElements) {
            if (getComputedStyle(focusableElement).display != 'none' && getComputedStyle(focusableElement).visibility != 'hidden') { // @ts-ignore
